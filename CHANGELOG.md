...
- cli: documented retry backoff

## [Unreleased] - 2024-03-03

- config loader: documented timeout handling

## [Unreleased] - 2025-06-20

- sdk: extended reconnect logic
...
- config loader: fixed error messages
...
- checkpoint resume: extended retry backoff
...
- checkpoint resume: clarified sampling window
...
- event bus: rewritten timeout handling
...
- api handlers: guarded threshold checks
...
- cli: documented edge case

## [Unreleased] - 2025-12-04

- api handlers: clarified edge case
...
- exporter: extended log formatting

## [Unreleased] - 2024-07-31

- event bus: fixed threshold checks
...
- monitor: rewritten timeout handling
